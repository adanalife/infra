...
resource "aws_secretsmanager_secret" "tripbot_db_credentials" {
  ...
  description = "Postgres credentials for tripbot on adanalife-minipc. JSON: {user, password, db}. Password generated by random_pet; rotate via keepers on the random_pet resource."
}
