...
k3d cluster create adanalife-stage-1 --volume "$(pwd)/k8s/traefik/stage-1/config.yml:/var/lib/rancher/k3s/server/manifests/traefik.yaml:ro" -p "8443:443@loadbalancer"
